    ...
    <div class="row">
        <nav class="z-depth-0 header">
            ...
            <ul id="nav-mobile" class="right">
                <li><span class="company_name">RS AUTOWERKPLAATS</span></li>
            ...
            <div class="container white _container">
                ...
                <div class="tab_container">
                    <div class="button_container">
                        ...
                        <button class="reparatie_tab" onclick="ShowPanel(0, '#2a1fa2')">
                            <h3 class="tab_text_reparatie">Reparatie</h3>
                            <div>
                                <svg width="75" height="75" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <button class="wegsleep_tab" onclick="ShowPanel(1, '#2a1fa2')">
                            <h3 class="tab_text_wegsleep">Wegsleep</h3>
                            <div>
                            <svg width="75" height="75" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <button class="keuring_tab" onclick="ShowPanel(2, '#2a1fa2')">
                            <h3 class="tab_text_keuring">Keuring</h3>
                            <div>
                            <svg width="75" height="75" viewBox="0 0 47 47" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g clip-path="url(#clip0)">
                ...
                <div class="fixed-action-btn">
                    ...
                    <ul>
                        ...
                        <li><a class="btn-floating blue darken-4"><i class="material-icons">directions_car</i></a></li>
                        <li><a class="btn-floating yellow darken-1"><i class="material-icons">build</i></a></li>
                    </ul>
                </div>

                                ...
                                <nav>
                                    <div class="nav-wrapper blue-grey lighten-3">
                                        <div class="input-field">
                                            <input id="search" type="search" onkeyup="searchFunction()" placeholder="Zoeken..." required>
                                                ...
                                                <table class="wegsleepTabel">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        while ($row = mysqli_fetch_array($wegsleepQuery)) {
                                                            ...
                                                            echo "<td>" . $row['model'] . "</td>";
                                                            echo "<td>" . $row['kenteken_nr'] . "</td>";
                                                            "<td>" . $row['wegsleep_id'] . "</td>";

                                                            $wsdate = $row['wegsleep_datum'];
                                                            $origDate = date('d-m-y', strtotime($wsdate));
